...
void Lista<TIPODATO>::insertar(int indice, TIPODATO item){
	...
	cout << endl << "Insertando un elemento..." << endl;
	...
	cout << endl << " Insertando elemento " << item << " en el indice " << indice << endl;
	this->items[indice] = item;
	//incrementar la cuenta de elementos
	cout << endl << " Incrementando la cuenta de elementos" << endl;
	this->cuenta++; 
	}
...
TIPODATO Lista <TIPODATO>::remover(int indice){
	...
	cout << endl << " Reduciendo la cuenta de elementos" << endl;
	this->cuenta--;
	return valor;
}
